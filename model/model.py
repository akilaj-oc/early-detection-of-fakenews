...
'''
split data
python data/split_train_dev.py --input data/dataset.json -d 2021-12-13 --train_output train_1.json --dev_output dev_1.json

train model
python model/main.py --mode train --config config.json --train_file train_1.json --dev_file train_1.json --lr 0.2 --batch_size 128 --cuda 0
